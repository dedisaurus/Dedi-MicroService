...
exports.getUserByAccountNumber = function(req, res, next) {
  var accountnumber = req.param.accountnumber;
  Task.findOne({ accountnumber: accountnumber }, function(err, data) {
     if (err) {
         next.ifError(err);
     }
     res.send({
...
exports.getUserByIdentityNumber= function(req, res, next) {
  var identitynumber = req.param.identitynumber;
  Task.findOne({ identitynumber: identitynumber }, function(err, data) {
     if (err) {
         next.ifError(err);
     }
     res.send({
